...
int main(int argc, char** argv)
{
	...
	prb_sfm_del     [prb::sck::probe        ::in     ] = (*sync_frame   )[sfm::sck::synchronize2 ::DEL     ];
	prb_sfm_tri     [prb::sck::probe        ::in     ] = (*sync_frame   )[sfm::sck::synchronize2 ::TRI     ];
	prb_sfm_flg     [prb::sck::probe        ::in     ] = (*sync_frame   )[sfm::sck::synchronize2 ::FLG     ];
	...
	if (!params.no_wl_phases) {
		...
		std::vector<runtime::Task*> firsts_l3 = { &(*radio    )[rad::tsk::receive], &prb_thr_lat [prb::tsk::probe],
		                                          ...
		                                          &prb_fra_id  [prb::tsk::probe  ], &prb_fra_sid [prb::tsk::probe],
