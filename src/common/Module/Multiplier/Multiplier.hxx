...
init_processes()
{
	...
	this->create_codelet(p1, [this, &p1s_X_N, &p1s_Z_N]() -> int
	{
		this->imultiply(static_cast<R*>(p1s_X_N.get_dataptr()),
		                static_cast<R*>(p1s_Z_N.get_dataptr()));
	...
	this->create_codelet(p2, [this, &p2s_X_N, &p2s_Y_N, &p2s_Z_N]() -> int
	{
		this->multiply(static_cast<R*>(p2s_X_N.get_dataptr()),
		               static_cast<R*>(p2s_Y_N.get_dataptr()),
		               static_cast<R*>(p2s_Z_N.get_dataptr()));
