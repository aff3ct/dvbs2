...
: Filter_FIR_ccr<R>(N, this->compute_rrc_coefs(rolloff, samples_per_symbol, delay_in_symbol)), rolloff(rolloff), samples_per_symbol(samples_per_symbol), delay_in_symbol(delay_in_symbol)
{
}
