...
class Synchronizer_freq_fine : public spu::module::Stateful, public spu::tools::Interface_reset
{
public:
	inline spu::runtime::Task&   operator[](const sff::tsk              t) { return spu::module::Module::operator[]((int)t);                             }
	inline spu::runtime::Socket& operator[](const sff::sck::synchronize s) { return spu::module::Module::operator[]((int)sff::tsk::synchronize)[(int)s]; }
