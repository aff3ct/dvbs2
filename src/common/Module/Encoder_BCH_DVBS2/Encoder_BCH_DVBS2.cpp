...
template <typename B>
Encoder_BCH_DVBS2<B>
::Encoder_BCH_DVBS2(const int& K, const int& N, const tools::BCH_polynomial_generator<B>& GF_poly, const int n_frames)
...
template <typename B>
Encoder_BCH_DVBS2<B>* Encoder_BCH_DVBS2<B>
::clone() const
{
